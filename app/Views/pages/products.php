        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="<?= base_url('public/assets/img/product/'.$row['image']) ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="<?= base_url('public/assets/img/product/'.$row['image']) ?>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li>
                                               <form  method="post" action="<?= base_url('cart/addajax') ?>" class="add-cart-form">
                                                    <?= csrf_field() ?>
                                                    <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                                    <input type="hidden" name="name" value="<?= $row['name'] ?>">
                                                    <input type="hidden" name="price" value="<?= $row['price'] ?>">
                    ...
                    <?= $pager->links('default', 'ogani_pager') ?>
