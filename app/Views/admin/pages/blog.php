...
<script>
const data = <?= json_encode($blog, JSON_UNESCAPED_UNICODE) ?>;
</script>
...
const table = new Tabulator("#blog-table", {
    data: data,
    layout: "fitColumns",
    pagination: true,
    paginationSize: 10,
    columns: [
        ...
        },
        {
            ...
            formatter: function(cell){
                ...
                return `
                    <img src="<?= base_url('public/assets/img/blog') ?>/${image}"
                         width="50"
                         height="50"
        ...
        },
        {
            ...
            formatter: function(cell){
                ...
                return `
                      ...
                      <a href="<?= base_url('admin/blog/edit') ?>/${row.id}" >
                        <button type="button" class="btn btn-sm btn-outline-secondary">
