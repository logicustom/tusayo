              ...
              <div class="card-body">
                <div class="d-flex gap-2 mb-3">
                  <div class="mb-3">
                      ...
                      <a href="<?= base_url('admin/client/add') ?>" >
...
<script>
const data = <?= json_encode($client, JSON_UNESCAPED_UNICODE) ?>;
</script>
    ...
    columns: [
        ...
        },
        {
            ...
            formatter: function(cell){
                ...
                return `
                    <img src="<?= base_url('public/uploads') ?>/${image}"
                         width="50"
                         height="50"
        ...
        },
        {
            ...
            formatter: function(cell){
                ...
                return `
                      ...
                      <a href="<?= base_url('admin/client/edit') ?>/${row.id}" >
                        <button type="button" class="btn btn-sm btn-outline-secondary">
                    ...
                    <!--<a href="<?= base_url('admin/client/delete') ?>/${row.id}"
