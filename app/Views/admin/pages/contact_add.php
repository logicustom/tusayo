          ...
          <?php endif; ?>
              ...
              <div class="col-lg-12">
                <div class="card card-success card-outline mb-4">
                  ...
                  <div class="card-body">
                  <form action="<?= base_url('contact/save') ?>"
                        method="post"
                        enctype="multipart/form-data">
                      <div class="row g-3">
                        <div class="col-md-6">
                          <label for="vt-first" class="form-label">Email</label>
                          <input
                            type="text"
                            class="form-control"
                            id="vt-first"
                        ...
                        <div class="col-md-6">
                          <label for="vt-username" class="form-label">Address</label>
                          <textarea class="form-control" id="vt-username" name="alamat" required></textarea>
                        </div>
                        <div class="col-md-6">
