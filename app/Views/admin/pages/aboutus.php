              ...
              <div class="card-body">
                <div class="d-flex gap-2 mb-3">
                  <div class="mb-3">
                      ...
                      <a href="<?= base_url('admin/aboutus/add') ?>" >
...
<script>
const data = <?= json_encode($about_us, JSON_UNESCAPED_UNICODE) ?>;
</script>
...
const table = new Tabulator("#contact-table", {
    data: data,
    layout: "fitColumns",
    pagination: true,
    paginationSize: 10,
        ...
        },
        {
            ...
            formatter: function(cell){
                ...
                return `
                      ...
                      <a href="<?= base_url('admin/aboutus/edit') ?>/${row.id}" >
                        <button type="button" class="btn btn-sm btn-outline-secondary">
                    ...
                    <!--<a href="<?= base_url('admin/aboutus/delete') ?>/${row.id}"
